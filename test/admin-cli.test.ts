...
test("fmtFleet: online dot · model · spend · revoked marker; empty → message", () => {
  ...
  const out = fmtFleet([
    { device_id: "d1", name: "jeff-mbp", os: "darwin", online: true, token_active: true, model: "glm-5", spend: 1.2, spend_available: true },
    { device_id: "d2", name: "old", os: "linux", online: false, token_active: false, model: "", spend: null, spend_available: false },
  ]);
