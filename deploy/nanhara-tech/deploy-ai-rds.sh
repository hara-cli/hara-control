...
unset HARA_FEEDBACK_INTAKE_KEY HARA_FEEDBACK_INTAKE_KEYFILE
unset HARA_KMS_MASTER_KEY HARA_KMS_KEYFILE LITELLM_MASTER_KEY UPSTREAM_API_KEY
unset HARA_CRASH_FEISHU_APP_ID HARA_CRASH_FEISHU_APP_SECRET
unset HARA_CRASH_FEISHU_CHAT_ID HARA_CRASH_FEISHU_MENTION_OPEN_ID
